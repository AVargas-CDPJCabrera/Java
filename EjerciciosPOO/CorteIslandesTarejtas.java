    ...
    switch (opcion) {
        case 1:
            ...
            if (numTarjetas==1) {
                ...
                System.out.println("Tarjeta generada con exito. Numero de tarjeta: " + tarjeta.getNumeroTarjeta() + ", Saldo: " + tarjeta.getSaldo());
            }
        ...
        case 3:
            ...
            if (gastar>tarjetaGastar.getSaldo()) {throw new SaldoException("Saldo Insuficiente");
